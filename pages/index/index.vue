  ...
  <view>
    ...
    <view class="cu-bar tabbar bg-white shadow foot">
      <view class="action" @click="NavChange" data-cur="basics">
        ...
        <view :class="PageCur=='basics'?'text-green':'text-gray'">任务中心</view>
      </view>
      <view class="action" @click="NavChange" data-cur="component">
        <view class="cuIcon-cu-image">
          <image :src="'/static/tabbar/component' + [PageCur == 'component'?'_cur':''] + '.png'" />
        </view>
        <view :class="PageCur=='component'?'text-green':'text-gray'">我的任务</view>
      </view>
      <view class="action" @click="NavChange" data-cur="plugin">
        <view class="cuIcon-cu-image">
          <image :src="'/static/tabbar/plugin' + [PageCur == 'plugin'?'_cur':''] + '.png'" />
        </view>
        <view :class="PageCur=='plugin'?'text-green':'text-gray'">会员中心</view>
      </view>
      <view class="action" @click="NavChange" data-cur="plugin">
        <view class="cuIcon-cu-image">
          <image :src="'/static/tabbar/plugin' + [PageCur == 'plugin'?'_cur':''] + '.png'" />
